    ...
    public static class ModelBuilderExtentions
    {
        public static void Seed(this ModelBuilder modelBuilder)
        {
           ...
           new Product()
           {
            ...
            /*
            var roleId = new Guid("2F618986-90BC-42A8-A2C2-FA55F2450380");
            var adminId = new Guid("BC3D3BC5-F94E-4BD3-8B38-CE3E5E366C06");
            ...
            { 
                ...
                NormalizedEmail = "hoanglongcnttk42b@gmail.com",
                EmailConfirmed = true,
                PasswordHash = hasher.HashPassword(null, "&&Longdeptrai1"),
                SecurityStamp = string.Empty,
                FirstName = "Long",
                LastName = "Hoang",
                Dob = new DateTime(2021,8,3)
            });
